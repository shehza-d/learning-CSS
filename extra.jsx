        ...
        <div className="text-zinc-800">
          <h1 className="text-5xl font-bold flex items-center gap-5 md:text-4xl">
            ...
            <span className="w-[30px]">
              <TbNorthStar size={30} className="text-[#D46A8E]" />
            </span>
          </h1>
          <div className="mt-10">
            {data.description.map((val, index) => {
              return (
                <p
                  key={index}
                  className="mb-5 word_spacing text-base bg-slate-100 p-5 rounded-xl md:text-sm"
                >
                  {val}
                </p>
              );
        ...
        <div className="mt-20">
          ...
          <div className="mt-10">
            {data.outline.map((val, index) => {
              return (
                <div key={index}>
                  <h1 className="text-2xl text_gradient font-bold mb-5 mt-10 sm:text-xl">
                    {val.title}
                  </h1>
                  <div
                    className={
                      val.children?.length
                        ? "text-base md:text-sm text-zinc-800 bg-slate-100 p-5 md:p-3 rounded-xl"
                        : ""
                    }
                  >
